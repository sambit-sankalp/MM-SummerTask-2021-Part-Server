            ...
            <Table className={classes.table} aria-label="customized table">
                ...
                {articles.map((article) => (
                    <StyledTableRow key={article._id}>
                        ...
                        <StyledTableCell align="right">{article.writer}</StyledTableCell>
                        <StyledTableCell align="right">{article.category}</StyledTableCell>
                        <StyledTableCell align="right">{article.views}</StyledTableCell>
                        
                        <StyledTableCell align="center">
                            <Link to={`/admin/user/${article._id}/edit`}>
